...
def create_input_device(args):
    ...
    if args.input == "mediapipe":
        ...
        return Camera(camera_id=args.camera_id, show_preview=True)
...
def main():
    ...
    parser.add_argument("--camera-id", type=int, default=0,
                        help="OpenCV camera index for mediapipe input (default: 0)")
    parser.add_argument("--realsense", action="store_true",
                        help="Use an Intel RealSense instead of an OpenCV camera")
