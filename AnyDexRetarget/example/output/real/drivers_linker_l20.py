...
# Linker Hand L20V10 CAN protocol position ranges.  The non-thumb yaw joints
# are centered around the URDF neutral qpos, so the 0~30 deg protocol range is
# represented as -15~15 deg before normalizing to the CAN command range.
_L20_DEG_TO_RAD = np.pi / 180.0
_L20_JOINT_LIMITS = {
    "THUMB_CMC_YAW": (0.0, 90.0 * _L20_DEG_TO_RAD),
    "THUMB_CMC_ROLL": (0.0, 80.0 * _L20_DEG_TO_RAD),
    "THUMB_CMC_PITCH": (0.0, 47.9 * _L20_DEG_TO_RAD),
    "THUMB_MCP": (0.0, 155.7 * _L20_DEG_TO_RAD),
    "INDEX_MCP_ROLL": (-15.0 * _L20_DEG_TO_RAD, 15.0 * _L20_DEG_TO_RAD),
    "INDEX_MCP_PITCH": (0.0, 75.0 * _L20_DEG_TO_RAD),
    "INDEX_PIP": (0.0, 75.0 * _L20_DEG_TO_RAD),
    "MIDDLE_MCP_ROLL": (-15.0 * _L20_DEG_TO_RAD, 15.0 * _L20_DEG_TO_RAD),
    "MIDDLE_MCP_PITCH": (0.0, 75.0 * _L20_DEG_TO_RAD),
    "MIDDLE_PIP": (0.0, 75.0 * _L20_DEG_TO_RAD),
    "RING_MCP_ROLL": (-15.0 * _L20_DEG_TO_RAD, 15.0 * _L20_DEG_TO_RAD),
    "RING_MCP_PITCH": (0.0, 75.0 * _L20_DEG_TO_RAD),
    "RING_PIP": (0.0, 75.0 * _L20_DEG_TO_RAD),
    "PINKY_MCP_ROLL": (-15.0 * _L20_DEG_TO_RAD, 15.0 * _L20_DEG_TO_RAD),
    "PINKY_MCP_PITCH": (0.0, 75.0 * _L20_DEG_TO_RAD),
    "PINKY_PIP": (0.0, 75.0 * _L20_DEG_TO_RAD),
}
...
# Optional simulation-qpos -> normalized real-hand command alignment.  Keep this
# empty so normalization follows the vendor L20V10 CAN angle ranges above.
